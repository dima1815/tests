...
/**
 * Creates {@link java.io.PrintStream} instances that write to a file identified by the
 * {@link StoryLocation}. {@link org.jbehave.core.reporters.FilePrintStreamFactory.FileConfiguration} specifies directory and the
...
public class FilePrintStreamFactory implements PrintStreamFactory {
     ...
     * {@link org.jbehave.core.reporters.FilePrintStreamFactory.FilePathResolver}
     *
