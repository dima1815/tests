...
public class PatternVariantBuilder {
     ...
     * </p>
     * <p>
     * Generated variants are stored in a {@link java.util.Set}, so there will never be
     ...
     *
     * @return a {@link java.util.Set} of all variants without whitespace compression
     ...
     * @return a {@link java.util.Set} of all variants
     */
