...
<#macro renderMillis stats name class=""><#assign millis = stats.get(name)!0><span
        ...
        <#if name != "Totals">
            <tr>
                ...
                <td>
                    ...
                    <#list filesByFormat.keySet() as format><#assign file = filesByFormat.get(format)><a
                            href="${file.name}">${format}</a><#if format_has_next> |</#if></#list>
                </td>
            </tr>
        </#if>
    </#list>
